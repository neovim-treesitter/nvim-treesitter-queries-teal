# nvim-treesitter-queries-teal

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-teal/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-teal/actions/workflows/validate.yml)

Neovim tree-sitter queries for **teal**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-teal",
...
- [ ] Changes are scoped to `teal` — do not include files for other languages
